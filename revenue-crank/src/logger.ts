 ...
 *
 * Mirrors the merkle-publisher pattern (see ../merkle-publisher/src/logger.ts).
 * Kept inline rather than imported because Layer 8 cranks are a separate
 * workspace and we want each crank to be runnable in isolation.
 */
